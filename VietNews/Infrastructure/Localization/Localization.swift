...
enum L10n: String, CaseIterable {
    ...
    case storageExplain = "storage.explain"
    case aboutVersion = "about.version"
    case aboutAPIKeyNotice = "about.apiKeyNotice"
    ...
    case subscribeTitle = "subscribe.title"
    case subscribeAddress = "subscribe.address"
    case subscribePlaceholder = "subscribe.placeholder"
    case subscribeCheck = "subscribe.check"
    case subscribeAdd = "subscribe.add"
    case subscribeCancel = "subscribe.cancel"
    case subscribeChecking = "subscribe.checking"
    case subscribeErrorNotAnAddress = "subscribe.error.notAnAddress"
    case subscribeErrorInsecure = "subscribe.error.insecure"
    case subscribeErrorDuplicate = "subscribe.error.duplicate"
    case subscribeErrorUnreachable = "subscribe.error.unreachable"
    case subscribeErrorUnreadable = "subscribe.error.unreadable"
